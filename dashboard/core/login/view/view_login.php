...
class view_login extends lychas_view_core {
    ...
    public function create_output() {
        if (isset($_SESSION['login_error'])) {
            $a_variables['{[tpl_login_error]}'] = '<div id="fehlermeldung">' . $_SESSION['login_error'] . '</div>';
        ...
        $a_variables['{[tab_register]}'] = '';
        $a_variables['{[tab_login]}'] = 'active';
